...
document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch("http://localhost/TWProject/backend/pictures", {
        method: "GET",
        headers: {
        ...
        .then(function(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                let id = data[i].id;
                let picture = data[i].download_link;
                ...
                let row = "<tr><td>" + id + "</td><td class=\"td-picture\">" + "<img src=\"" + picture + "\" alt=\"image\" class=\"picturetd\">"+ "</td><td>"+ changeButton +"</td></tr>";
